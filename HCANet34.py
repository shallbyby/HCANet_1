...
import torch
import numpy as np
from network.HCA34 import FCNRes34
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', default='HCA34', type=str)
    ...
    parser.add_argument('--savedir', default="./runs_VAI_HCA34/", help="directory to save the model snapshot")
    # parser.add_argument('--logFile', default= "log.txt", help = "storing the training and validation logs")
    parser.add_argument('--gpu', type=str, default="0", help="default GPU devices (7)")
